  ...
  const psychologists = [
    {
      ...
      description:
        "Spesialis dalam menangani kecemasan, stres, dan gangguan mood. Berpengalaman dalam terapi kognitif-behavioral.",
    },
    {
      id: 2,
      ...
      photo: "/placeholder.svg",
      description:
        "Profesor psikologi klinis dengan keahlian dalam menangani depresi, trauma, dan membangun kepercayaan diri.",
    },
    {
      id: 3,
      ...
      photo: "/placeholder.svg",
      description:
        "Ahli dalam menangani burnout, stres kerja, dan membantu mencapai keseimbangan hidup yang sehat.",
    },
  ];
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Konsultasi dengan psikolog profesional yang berpengalaman
          </p>
        </div>
          ...
          <Card className="mt-8">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex gap-4">
                <Button className="flex-1">Konfirmasi Jadwal</Button>
                <Button
                  variant="outline"
